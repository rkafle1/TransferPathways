...
def rank_heatmap():
    ...
    figure7 = plt.figure(figsize=(50, 20))
    ...
    axis7.set_title("Heatmap of percentages of Met Math/CS Requirements", fontsize=50)
    axis7.set_xlabel("Community Colleges", fontsize=30)
    axis7.set_ylabel("Universities", fontsize = 30)
    # axis6.xaxis.tick_top()
    axis7.set_yticklabels(CSVHandling.UniNameShort, fontsize=15)
    ...
    axis7.set_xticklabels(ccNameNumber, fontsize=7, rotation=0)
