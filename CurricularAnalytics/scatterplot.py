...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 26 15:00:12 2023
...
def build_scatter_plot(data, labels):
    # Create a scatter plot using matplotlib
    plt.figure(figsize=(8, 6))
    plt.scatter(labels, data)  # Use scatter() instead of bar()
...
def main(folder_path):
    ...
    build_scatter_plot(data, labels)  # Use build_scatter_plot() instead of build_bar_chart()
